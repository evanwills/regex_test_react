...
export const makeModifiers = (id: number, modifiers: string, pattern: string, error: string = null) => {
  ...
  <div className="regex-pair__modifiers{errorMeta.errorClass}">
    ...
    <input type="text" className="regex-pair__input regex-pair__input--modifiers{errorMeta.errorClass}" name="regex-pair--{id}__modifiers" id="regex-pair--{id}__modifiers" value="{modifiers}" />
